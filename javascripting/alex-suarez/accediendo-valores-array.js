/*
 ## ACCEDIENDO ARRAYS (Ejercicio 13 de 20)

  Se puede tener acceso a los elementos de un Array a través del número de
  índice.
  ...
  El código de arriba, imprime el primer elemento del array de pets - string
  cat
