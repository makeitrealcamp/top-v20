/*
 ## BLOQUE CONDICIONAL (Ejercicio 9 de 20)

  Los bloques condicionales son utilizados, partiendo de una condición
  booleana específica, alterar el control de flujo de un programa.
  ...
  Dentro de los paréntesis debes ingresar una sentencia lógica, significa
  que deberá ser verdadera (true) o falsa (false).

  El else block es opcional y contiene el código que será ejecutado si la
  sentencia lógica dentro de los paréntesis es falsa.
 ...
 ## El ejercicio
  ...
  has more than five characters." si el length de la variable fruit es mayor
  a cinco. Imprime "The fruit name has five characters or less." de lo
  contrario.

  Comprueba si tu programa funciona correctamente ejecutando el siguiente
  comando:
